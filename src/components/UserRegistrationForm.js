...
class UserRegistrationForm extends React.Component {
    ...
    sumUp = (name, id) => {
        ...
        this.props.order[id] = {}
        this.props.order[id].name = id
        this.props.order[id].value = sum
    }
    sumGroup = (event) => {
    ...
    makeTextProduct(happening, parts, part, product) {
        console.log("makeTextProduct: "+product.name +" :"+this.props.order[product.name])
    ...
    makeNumberProduct(happening, parts, part, product) {
        ...
        if (this.props.order && this.props.order[product.name]) defaultValue = this.props.order[product.name]
